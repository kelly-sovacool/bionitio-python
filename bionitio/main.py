...
def parse_args():
    ...
    parser.add_argument(
        "--version", action="version", version="%(prog)s " + PROGRAM_VERSION
    )
    parser.add_argument(
        "--log",
        metavar="LOG_FILE",
...
class FastaStats(object):
    ...
    def __init__(
        self, num_seqs=None, num_bases=None, min_len=None, max_len=None, average=None
    ):
    ...
    def __repr__(self):
        ...
        return (
            "FastaStats(num_seqs={}, num_bases={}, min_len={}, max_len={}, "
            "average={})".format(
